...
// PDF oder Bild-Datei → Array von dataURL-Strings
// Wrapper um fileToDataURLs aus core/media.js; longEdge 1200 ≈ scale 1.5 auf A4
async function pdfToImages(file, longEdge = 1200) {
  return fileToDataURLs(file, { longEdge, quality: 0.88 });
}
